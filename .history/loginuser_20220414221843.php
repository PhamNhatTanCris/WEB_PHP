...
<section class="login">
		<div class="login_box">
			<div class="left">
				<div class="top_link"><a href="#"><img src="https://luxshopping.vn/Uploads/UserFiles/images/banner%20dong%20ho%20frederique%20constaint.png" alt="">Return home</a></div>
				<div class="contact">
					<form action="" method="POST">
						<h3>SIGN IN</h3>
						<input type="text" name="taikhoan" placeholder="USERNAME">
						<input type="password" name="password" placeholder="PASSWORD">
						<button class="submit" name="dangnhap">LET'S GO</button>
					</form>
				</div>
			</div>
			<div class="right">
