    ...
    <form class="form-sp" action="pages/main/giohang/themgiohang.php?idsanpham=<?php echo $row_chitiet['id_sanpham'] ?>" method="POST">
        <div class="chitiet_sanpham">
            ...
            <div class="soluong-sp">
                  ...
                  <p class="soluong-sp-cosan"><?php echo $row_chitiet['soluong'] ?></p>
            </div>
 ...
 <script type="text/javascript">
      ...
      var slcosan = document.querySelector('.soluong-sp-cosan');
      ...
      demPlus.addEventListener('click',function(){
         // console.log("hi");
         // soluong.value++;
         if(soluong.value>slcosan){
            soluong.value=slcosan.value;
         } else {
            soluong.value++;
         }
      })
