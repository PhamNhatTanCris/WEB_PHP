 ...
 <div class="hinhanh_sanpham">
    ...
    <form action="pages/main/giohang/themgiohang.php?idsanpham=<?php echo $row_chitiet['id_sanpham'] ?>" method="POST">
        <div class="chitiet_sanpham">
            ...
            <div class="price">          
                  <p class="gia-cu"><?php echo $row_chitiet['giasanpham']*(10/100)+ $row_chitiet['giasanpham']?></p>
                  <h5 class="gia-now">Giá: <?php echo number_format($row_chitiet['giasanpham'],0,',','.') ?> VNĐ</h5>
            </div>
